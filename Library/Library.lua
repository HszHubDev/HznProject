...
ColorSequenceKeypoint.new(0.00,Color3.fromRGB(255,240,247)),
ColorSequenceKeypoint.new(0.50,Color3.fromRGB(255,228,239)),
ColorSequenceKeypoint.new(1.00,Color3.fromRGB(255,240,247))
},
Primary=Color3.fromRGB(255,145,190),
OnPrimary=Color3.fromRGB(255,190,215),
ScrollBar=Color3.fromRGB(255,150,195),
Stroke=Color3.fromRGB(255,195,220),

Error=Color3.fromRGB(255,105,150),
Icons=Color3.fromRGB(150,70,105),

JoinButton=Color3.fromRGB(255,130,180),
Link=Color3.fromRGB(255,105,170),

Dialog={
Background=Color3.fromRGB(255,235,243)
},
Buttons={
Holding=Color3.fromRGB(255,220,235),
Default=Color3.fromRGB(255,242,248)
},
Border={
Holding=Color3.fromRGB(255,170,205),
Default=Color3.fromRGB(255,195,220),
},
Text={
Default=Color3.fromRGB(110,45,75),
Dark=Color3.fromRGB(145,75,105),
Darker=Color3.fromRGB(175,100,130),
},
Slider={
SliderBar=Color3.fromRGB(255,150,195),
SliderNumber=Color3.fromRGB(150,70,105),
},
Dropdown={
Holder=Color3.fromRGB(255,238,246),
}
},
Icons={
...
Corner=function(H)
return E("UICorner",{
CornerRadius=H or UDim.new(0,12)
})
end,
Stroke=function(H,I)
return E("UIStroke",{
