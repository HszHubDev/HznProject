...
ColorSequenceKeypoint.new(0.00,Color3.fromRGB(9,0,12)),
ColorSequenceKeypoint.new(0.50,Color3.fromRGB(42,0,48)),
ColorSequenceKeypoint.new(1.00,Color3.fromRGB(9,0,12))
},
Primary=Color3.fromRGB(255,0,170),
OnPrimary=Color3.fromRGB(255,80,205),
ScrollBar=Color3.fromRGB(235,0,160),
Stroke=Color3.fromRGB(125,0,100),

Error=Color3.fromRGB(255,40,115),
Icons=Color3.fromRGB(205,45,155),

JoinButton=Color3.fromRGB(255,0,155),
Link=Color3.fromRGB(255,20,180),

Dialog={
Background=Color3.fromRGB(24,0,28)
},
Buttons={
Holding=Color3.fromRGB(50,0,55),
Default=Color3.fromRGB(22,0,25)
},
Border={
Holding=Color3.fromRGB(145,0,120),
Default=Color3.fromRGB(125,0,100),
},
Text={
Default=Color3.fromRGB(245,225,245),
Dark=Color3.fromRGB(220,175,220),
Darker=Color3.fromRGB(180,115,175),
},
Slider={
SliderBar=Color3.fromRGB(235,0,160),
SliderNumber=Color3.fromRGB(205,45,155),
},
Dropdown={
Holder=Color3.fromRGB(28,0,32),
}
},
Icons={
